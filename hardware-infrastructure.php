    ...
    <div class="container pl-2 pr-2">
        ...
        <form id="equipmentForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="laptopDesktop"
                            id="laptopDesktopYes" value="Yes" required>
                        <label class="custom-label form-check-label" for="laptopDesktopYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="laptopDesktop"
                            id="laptopDesktopNo" value="No" required>
                        <label class="custom-label form-check-label" for="laptopDesktopNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="laptopDesktopRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="laptopDesktopRemarks" id="laptopDesktopRemarks" rows="2"
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="printer" id="printerYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="printerYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="printer" id="printerNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="printerNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="printerRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="printerRemarks" id="printerRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="scanner" id="scannerYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="scannerYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="scanner" id="scannerNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="scannerNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="scannerRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="scannerRemarks" id="scannerRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="biometric" id="biometricYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="biometricYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="biometric" id="biometricNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="biometricNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="biometricRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="biometricRemarks" id="biometricRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="posTerminal" id="posTerminalYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="posTerminalYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="posTerminal" id="posTerminalNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="posTerminalNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="posTerminalRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="posTerminalRemarks" id="posTerminalRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="internetRouter"
                            id="internetRouterYes" value="Yes" required>
                        <label class="custom-label form-check-label" for="internetRouterYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="internetRouter"
                            id="internetRouterNo" value="No" required>
                        <label class="custom-label form-check-label" for="internetRouterNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="internetRouterRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="internetRouterRemarks" id="internetRouterRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="ups" id="upsYes" value="Yes"
                            required>
                        <label class="custom-label form-check-label" for="upsYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="ups" id="upsNo" value="No"
                            required>
                        <label class="custom-label form-check-label" for="upsNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="upsRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if any):</label>
                    <textarea class="form-control" name="upsRemarks" id="upsRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="cctvCamera" id="cctvCameraYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="cctvCameraYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="cctvCamera" id="cctvCameraNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="cctvCameraNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="cctvCameraRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="cctvCameraRemarks" id="cctvCameraRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="mobileTablet"
                            id="mobileTabletYes" value="Yes" required>
                        <label class="custom-label form-check-label" for="mobileTabletYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="mobileTablet"
                            id="mobileTabletNo" value="No" required>
                        <label class="custom-label form-check-label" for="mobileTabletNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="mobileTabletRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="mobileTabletRemarks" id="mobileTabletRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="countingMachine"
                            id="countingMachineYes" value="Yes" required>
                        <label class="custom-label form-check-label" for="countingMachineYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="countingMachine"
                            id="countingMachineNo" value="No" required>
                        <label class="custom-label form-check-label" for="countingMachineNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="countingMachineRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="countingMachineRemarks" id="countingMachineRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="cardReader" id="cardReaderYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="cardReaderYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="cardReader" id="cardReaderNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="cardReaderNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="cardReaderRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="cardReaderRemarks" id="cardReaderRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="externalHDD" id="externalHDDYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="externalHDDYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="externalHDD" id="externalHDDNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="externalHDDNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="externalHDDRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="externalHDDRemarks" id="externalHDDRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="photocopier" id="photocopierYes"
                            value="Yes" required>
                        <label class="custom-label form-check-label" for="photocopierYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="photocopier" id="photocopierNo"
                            value="No" required>
                        <label class="custom-label form-check-label" for="photocopierNo">No</label>
                    </div>
                </div>
                <!-- Remarks -->
                <div class="form-group dark">
                    <label for="photocopierRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="photocopierRemarks" id="photocopierRemarks" rows="2"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <textarea class="form-control" name="otherDevices" id="otherDevices" rows="3"
                    placeholder="Enter Device names"></textarea>
            </div>

            <div class="form-group dark">
                <label for="hardwarePhotoPreview">15. Capture Hardware's Photo:</label>
                <div>
                    <img id="hardwarePhotoPreview" class="mt-2 mb-3 img-thumbnail" src="default-image.png"
                        alt="Image preview">
                </div>
                <div>
                    <a class="btn btn-primary mr-2" id="openCaptureModalBtnHardware" data-bs-toggle="modal"
                        data-bs-target="#photoCaptureModal">Capture Hardware's Photo</a>
                </div>
