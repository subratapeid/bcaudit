    ...
    <table id="dataTable">
      <thead>
        <tr>
          ...
          <th data-column="auditNumber" class="sortable" id="header-audit_number">Audit Number <span
              class="sort-icon"></span></th>
          <th data-column="bcaId" class="sortable" id="header-bca_id">BCA ID <span class="sort-icon"></span></th>
          <th data-column="bcaFullName" class="sortable pl-3 pr-3" id="header-bca_full_name">BCA Full Name <span
              class="sort-icon"></span></th>
          <th data-column="bcaFullName" class="sortable pl-3 pr-3" id="header-mobile_no">Mobile No<span
              class="sort-icon"></span></th>
          ...
          <th data-column="bcaFullName" class="sortable" id="header-location">Location <span class="sort-icon"></span>
          </th>
          <th data-column="status" class="sortable" id="header-status">Audit Status <span class="sort-icon"></span></th>
          <th data-column="date" class="sortable" id="header-formatted_date">Audit Date <span class="sort-icon"></span>
          </th>
