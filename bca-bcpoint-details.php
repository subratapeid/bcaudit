    ...
    <div class="container pl-2 pr-2">
        ...
        <form id="bcaForm" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group dark">
                ...
                <input type="text" class="form-control" id="bcaFullName" name="bcaFullName"
            ...
            <div class="form-group dark">
                ...
                <input type="text" class="form-control" id="bcPointName" name="bcPointName"
                    placeholder="Enter BC Point Name" value="" required>
            </div>
            ...
            <div class="form-group dark">
                ...
                <input type="text" class="form-control" name="state" id="state" placeholder="Enter State Name" value=""
                    required>
            ...
            <div class="form-group dark">
                ...
                <input type="text" class="form-control" id="location" name="location" placeholder="Enter BCA Location"
                    value="" required>
            </div>
            ...
            <div class="form-group dark">
                ...
                <input type="text" class="form-control" name="bcaBank" id="bcaBank" placeholder="Enter Bank Name"
                    value="" required>
            </div>

            <div class="form-group dark">
                <label for="bcaBankBranch">14. BCA Bank Branch</label>
                <input type="text" class="form-control" id="bcaBankBranch" name="bcaBankBranch"
                    placeholder="Enter Bank Branch" value="" required>
            </div>

            <div class="form-group dark">
                <label for="bcaPointAddress">15. BC Point Full Address</label>
                <textarea class="form-control" id="bcaPointAddress" name="bcaPointAddress" rows="4"
                    placeholder="Enter BC Point Address" required></textarea>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 form-group dark">
                    ...
                    <div>
                        <img id="bcaPhotoPreview" class="mt-2 mb-3 img-thumbnail" src="default-image.png"
                            alt="Image preview">
                    </div>
                    <div>
                        <a class="btn btn-primary mr-2" id="openCaptureModalBtnBca" data-bs-toggle="modal"
                            data-bs-target="#photoCaptureModal">Capture Photo With BCA</a>
                    </div>
                ...
                <div class="col-md-6 form-group dark">
                    ...
                    <div>
                        <img id="bcPointPhotoPreview" class="mt-2 mb-3 img-thumbnail" src="default-image.png"
                            alt="Image preview">
                    </div>
                    <div>
                        <a class="btn btn-primary mr-2" id="openCaptureModalBtnBcPoint" data-bs-toggle="modal"
                            data-bs-target="#photoCaptureModal">Capture BC Point Photo</a>
                    </div>
                ...
                <div class="col-md-6 form-group dark">
                    ...
                    <div>
                        <img id="bcSignaturePhotoPreview" class="mt-2 mb-3 img-thumbnail" src="default-image.png"
                            alt="Image preview">
                    </div>
                    <div>
                        <a class="btn btn-primary mr-2" id="openSignatureModalBtn" data-bs-toggle="modal"
                            data-bs-target="#signatureModal">Take BCA Signature</a>
                    </div>
                ...
                <div class="col-md-6 form-group dark">
                    ...
                    <div>
                        <img id="bcStampPreview" class="mt-2 mb-3 img-thumbnail" src="default-image.png"
                            alt="Image preview">
                    </div>
                    <div>
                        <a class="btn btn-primary mr-2" id="openCaptureModalBtnBcaStamp" data-bs-toggle="modal"
                            data-bs-target="#photoCaptureModal">Capture BC Stamp Photo</a>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer pt-2 pb-0 d-flex justify-content-between">
                    ...
                    <button type="button" class="iconButtons btn btn-danger" id="clearButton" title="Clear"><i
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateForm(formData) {
                ...
                $('#saveButton').prop('disabled', true);
                $.ajax({
                    url: 'codes/update_bca_bcpoint_form.php',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
