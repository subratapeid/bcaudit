...
<div class="table-container">
    <div class="header-container">
        <div class="header-title">Customer Feedback List</div>
        ...
        <table id="dataTable">
            <thead>
                <tr>
                    ...
                    <th data-column="bcaId" class="sortable" id="header-bca_id">Feedback ID <span
                            class="sort-icon"></span>
                    </th>
                    <th data-column="bcaFullName" class="sortable pl-3 pr-3" id="header-bca_full_name">Customer Name
                        <span class="sort-icon"></span>
                    </th>
                    <th data-column="bcaFullName" class="sortable pl-3 pr-3" id="header-mobile_no">Customer Mobile <span
                            class="sort-icon"></span></th>
                    <th data-column="bcaFullName" class="sortable" id="header-state">State <span
                            class="sort-icon"></span></th>
                    <th data-column="bcaFullName" class="sortable" id="header-location">Location <span
                            class="sort-icon"></span></th>
                    <th data-column="date" class="sortable" id="header-formatted_date">Feedback Date <span
                            class="sort-icon"></span></th>
                    <th data-column="bcaId" class="sortable" id="header-bca_id">BCA ID <span class="sort-icon"></span>
                    </th>
                    <th data-column="bcaFullName" class="sortable pl-3 pr-3" id="header-bca_full_name">BCA Name
                        <span class="sort-icon"></span>
                    </th>
                    <th data-column="bcaBank" class="sortable pl-3 pr-3" id="header-bca_bank">BCA Bank <span
                            class="sort-icon"></span></th>
                    <th data-column="auditorName" class="sortable" id="header-created_by">Created By <span
                            class="sort-icon"></span></th>
    ...
    <div class="modal fade" id="customerFeedbackModal" tabindex="-1" aria-labelledby="customerFeedbackModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="customerFeedbackModalLabel">Validate BCA ID</h4>
                ...
                <div class="modal-body pt-2 pb-3">
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col-10">
                            ...
                            <input type="text" class="form-control uppercase-input no-space" id="bcaId" name="bcaId"
                                placeholder="Enter a BCA ID" required>
                        </div>
                    </div>
                    <div class="form-group row justify-content-center">
                        <div class="col-10">
                            <label for="bcaName">BCA Full Name</label>
                            <input type="text" class="form-control" id="bcaName" name="bcaName" placeholder="" required
                                disabled>
                        </div>
                    </div>
        ...
        function renderTable(isDefault) {
            ...
            if (paginatedData.length === 0) {
                ...
                paginatedData.forEach((item, index) => {
                    ...
                    <td>
                    <button type="button" class="btn btn-info" data-bca-id="${item.bca_id}" title="Edit BCA Data"><i class="fas fa-eye"></i></button>
