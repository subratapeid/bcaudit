    ...
    <div class="container pl-2 pr-2">
        ...
        <form id="operationalForm" action="process_operational_form.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group dark">
                ...
                <input type="text" class="form-control" id="abeName" name="abeName" placeholder="Enter ABE Name"
                    required>
            </div>
            <div class="form-group dark">
                <label for="abmName">2. ABM Name</label>
                <input type="text" class="form-control" id="abmName" name="abmName" placeholder="Enter ABM Name"
                    required>
            </div>
            <div class="form-group dark">
            ...
            <!-- <div class="form-group dark">
                ...
                <div class="dropdown-checkbox">
                    ...
                    <div class="options" id="serviceOptions">
                        <label><input type="checkbox" name="bcaServices[]" value="Cash Deposit"
                                onclick="updateSelection()"> Cash Deposit</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Cash Withdrawal"
                                onclick="updateSelection()"> Cash Withdrawal</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Fund Transfer"
                                onclick="updateSelection()"> Fund Transfer</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Bill Payment"
                                onclick="updateSelection()"> Bill Payment</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Mobile Recharge"
                                onclick="updateSelection()"> Mobile Recharge</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Loan Assistance"
                                onclick="updateSelection()"> Loan Assistance</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Account Opening"
                                onclick="updateSelection()"> Account Opening</label>
                        <label><input type="checkbox" name="bcaServices[]" value="Aadhaar Linking"
                                onclick="updateSelection()"> Aadhaar Linking</label>
                    </div>
                </div>
            ...
            <!-- <script>
                ...
                function updateSelection() {
                    ...
                    if (checkboxes.length > 0) {
                        button.innerText = checkboxes.length + " services selected";
                        errorMessage.style.display = "none"; // Hide error message if selection is valid
                    } else {
                        button.innerText = "Select Services";
                    }
                }
            ...
            <div class="form-group dark">
                ...
                <textarea class="form-control" name="operatingHours" rows="3" id="operatingHours"
                    placeholder="Enter operating hours" required></textarea>
            </div>
            <div class="form-group dark">
                <label for="operatingLocation">6. BCA operated from the designated BCA Point?</label>
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="operatingLocation"
                            id="operatingLocationYes" value="Yes" required>
                        <label class="custom-label form-check-label" for="operatingLocationYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="operatingLocation"
                            id="operatingLocationNo" value="No" required>
                        <label class="custom-label form-check-label" for="operatingLocationNo">No</label>
                    </div>
                </div>
                <div class="form-group dark">
                    <label for="operatingLocationRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="operatingLocationRemarks" id="operatingLocationRemarks"
            ...
            <div class="form-group dark">
                ...
                <div>
                    <div class="form-check form-check-inline ml-4">
                        <input class="custom-radio form-check-input" type="radio" name="trainingGiven"
                            id="trainingGivenYes" value="Yes" required>
                        <label class="custom-label form-check-label" for="trainingGivenYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline ml-5">
                        <input class="custom-radio form-check-input" type="radio" name="trainingGiven"
                            id="trainingGivenNo" value="No" required>
                        <label class="custom-label form-check-label" for="trainingGivenNo">No</label>
                    </div>
                </div>
                <div class="form-group dark">
                    <label for="trainingRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="trainingRemarks" id="trainingRemarks" rows="3"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>

            <div class="form-group dark">
                <label for="businessExplore">8. Business Explore (IBKART, IRCTC, near shop, Acquiring new
                    location):</label>
                <div>
                    <div class="form-check form-check-inline ml-4">
                ...
                <div class="form-group dark">
                    <label for="businessExploreRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="businessExploreRemarks" id="businessExploreRemarks" rows="3"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <label for="targetSet"><span class="mdi mdi-hand-pointing-right"></span> Targets Were set and
                    communicated.</label>
                <div>
                    <div class="form-check form-check-inline ml-4">
                ...
                <label for="targetClear"><span class="mdi mdi-hand-pointing-right"></span> Targets are clear to the
                    BCA.</label>
                <div>
                    <div class="form-check form-check-inline ml-4">
                ...
                <label for="targetDocumented"><span class="mdi mdi-hand-pointing-right"></span> Are the visits by the
                ...
                <label for="abeSupport"><span class="mdi mdi-hand-pointing-right"></span> ABE Support for all BCA
                ...
                <label for="bankSupport"><span class="mdi mdi-hand-pointing-right"></span> Sufficient support from the
            ...
            <!-- <div class="form-group dark">
                ...
                <label for="feeUnclear"><span class="mdi mdi-hand-pointing-right"></span> Fee was unclearly explained,
                ...
                <label for="feesDocumented"><span class="mdi mdi-hand-pointing-right"></span> All the on-boarding fees
                ...
                <div class="form-group dark">
                    <label for="transactionModule"><span class="mdi mdi-hand-pointing-right"></span> How are fees
                        payments made?</label>
                ...
                <div class="form-group dark">
                    <label for="onboardingRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
            ...
            <div class="form-group dark">
                ...
                <div class="form-group dark">
                    <label for="rmVisitRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="rmVisitRemarks" id="rmVisitRemarks" rows="3"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <!-- <div class="form-group dark">
                ...
                <div class="form-group dark">
                    <label for="abmVisitRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="abmVisitRemarks" id="abmVisitRemarks" rows="3"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div class="form-group dark">
                    <label for="abeVisitRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="abeVisitRemarks" id="abeVisitRemarks" rows="3"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
            ...
            <div class="form-group dark">
                ...
                <div class="form-group dark">
                    <label for="bankOfficialVisitRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
            ...
            <div class="form-group dark">
                ...
                <div class="form-group dark">
                    <label for="bcVisitRemarks"><span class="mdi mdi-hand-pointing-right"></span> Remarks (if
                        any):</label>
                    <textarea class="form-control" name="bcVisitRemarks" id="bcVisitRemarks" rows="3"
                        placeholder="Enter your remarks"></textarea>
                </div>
            </div>
